...
from App.core.bitcoin_core import BitcoinCore, default_api_key_generator, default_address_generator, \
...
def get_in_memory_core() -> BitcoinCore:
    return BitcoinCore(user_repository=InMemoryUserRepository(),
